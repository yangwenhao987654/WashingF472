...
{
    public partial class FormRulesSetting : UIForm
    {
        public FormRulesSetting(int ruleId)
        {
            InitializeComponent();
            RuleId = ruleId;
        }
        ...
        private void ShowRuleTable(List<BarcodeRuleParameter> list)
        {
            ...
            dgv.SuspendLayout();
            list = list.OrderBy(r => r.Sequence).ToList();
            int index = 0;
            SeqMap = new Dictionary<int, int>();
